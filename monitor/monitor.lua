...
function set(monitorName)
    iMonitor = peripheral.wrap(monitorName)
end
...
function size()
    return iMonitor.getSize()
end

--setCursorPos wrapper
function setCursor(x,y)
    iMonitor.setCursorPos(x,y)
end

--getCursorPos wrapper
function getCursor()
    return iMonitor.getCursorPos()
end
...
function setTextColour(col)
    iMonitor.setTextColour(col)
end

--getTextColour wrapper
function setBackgroundColor(col)
    iMonitor.setBackgroundColour(col)
end
...
function getOldCursor()
    return oldCursor.x, oldCursor.y
end
